...
\IfFileExists{structure.tex}{
    \input{structure}
}{
    \typeout{Error: structure.tex file not found. Please ensure it exists in the same directory.}
}
...
%	CHAPTER 1
%----------------------------------------------------------------------------------------
\chapterimage{./Pictures/asymptotic_notation.png} % Chapter heading image
